...
var redis = require('redis')
  ...
  , cmd = redis.createClient('18162','pub-redis-18162.us-east-1-4.3.ec2.garantiadata.com')
  , evt = redis.createClient('18162','pub-redis-18162.us-east-1-4.3.ec2.garantiadata.com')
  , evtSubscriptions = []
  , cmdSubscriptions = [];

cmd.auth('1Aa8vlNScirgEnIT');
evt.auth('1Aa8vlNScirgEnIT');
